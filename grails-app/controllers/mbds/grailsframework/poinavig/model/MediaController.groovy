...
class MediaController {
    ...
    def save(Media media) {
        ...
        if (media.hasErrors() || !params.mediaFile) {
            transactionStatus.setRollbackOnly()
            respond media.errors, view: 'create'
            return
        }

        // creation d'un fileOutputStream pour sauvegarder l'image sur disque

        //new FileOutputStream(grailsApplication.config.media.path + "poi-" + t + "-image-" + t + ".png").leftShift(params.mediaFile.getInputStream());
