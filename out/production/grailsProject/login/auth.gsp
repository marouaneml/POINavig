...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="card">
                <div class="header">
                    <h4 class="title"><g:message code='springSecurity.login.header'/></h4>
                </div>
                <div class="content">
                    <div id="login">
                            ...
                            <form action="${postUrl ?: '/login/authenticate'}" method="POST" id="loginForm"
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                            ...
                                            <span class="custom-control-description"><g:message code='springSecurity.login.remember.me.label'/></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" id="submit"
                                            class="btn btn-info btn-fill btn-wd">${message(code: 'springSecurity.login.button')}</button>
                                </div>
